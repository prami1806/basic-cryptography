...
def rabinMiller(num):
    ...
    while s%2==0:
        ...
        # use t to count how many times we halve s:
        s=s//2
        t+=1
    for trial in range(5): # Try to falsify num's primality 5 times.
...
# by dividing the first few dozen prime numbers. This is quicker than
...
def isPrime(num):
    ...
    for prime in LOW_PRIMES:
        if (num%prime==0) and (num/prime)!=1:
            return False
